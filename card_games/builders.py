...
WIDTH_END_BUTTON = 70
HEIGHT_END_BUTTON = 50
BORDER_END_BUTTON = 50

def build_end_button(screen, screen_size, font):
    new_end_button = Button(
            ...
            width=WIDTH_END_BUTTON,
            height=HEIGHT_END_BUTTON,
            border=BORDER_END_BUTTON
        )
...
def display_card(screen, image, rect):
    ...
    hovering, clicked = track_mouse(x, y, width, height)
    color =  BLUE_TINT if hovering else WHITE
